...
public class ParsersConfig {
    ...
    public PaginationCallbackParser regionsPaginationCallbackParser() {
        return new PaginationCallbackParser(FilterSettingsCallbackKeys.SELECT_REGION.getKey());
    }

    @Bean
    public PaginationCallbackParser townsPaginationCallbackParser(){
        return new PaginationCallbackParser(FilterSettingsCallbackKeys.SELECT_TOWN.getKey());
    }
}
